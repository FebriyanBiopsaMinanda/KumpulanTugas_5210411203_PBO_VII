...
def menu_awal():
    while(True):    #5210411203_Febriyan
...
def getDate():
    ...
    return str(now().date())#5210411203_Febriyan
...
def pinjamkan_buku():
    success=False#5210411203_Febriyan
    while(True):
...
def kembalikan_buku():
    ...
    stat=input()        #5210411203_Febriyan
    if(stat.upper()=="Y"):
        ...
        with open("stock.txt","r+") as f:
            for i in range(8):      #5210411203_Febriyan
                f.write(judul_buku[i]+","+pengarang[i]+","+str(jumlah_stok[i])+"\n")
               #5210411203_Febriyan
menu_awal()
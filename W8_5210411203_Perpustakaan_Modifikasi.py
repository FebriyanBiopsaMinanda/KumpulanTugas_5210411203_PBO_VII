...
class Perpustakaan :
    def __init__(self, kode, judul, subjek, lokasi, info) :
        self.kode = kode
        self.judul = judul      #5210411203_Febriyan
        self.subjek = subjek
        self.lokasi = lokasi
        self.info = info
...
class Buku(Perpustakaan) :
    def __init__(self, kode, judul, subjek, lokasi, info, isbn, pengarang, jmlhal, ukuran):
        ...
        self.jmlhal = jmlhal        #5210411203_Febriyan
        self.ukuran = ukuran      
...
class DVD(Perpustakaan) :
    def __init__(self, kode, judul, subjek, lokasi, info, aktor, genre):
        super().__init__(kode, judul, subjek, lokasi, info)
        self.aktor = aktor
        self.genre = genre      #5210411203_Febriyan
...
majalah4 = Majalah("290", "Bleach", "Majalah Manga", "Rak 2", "Ada", "LXXVI", "Anime")  #5210411203_Febriyan
...
dvd3 = DVD("334", "One Piece", "softcopy", "Rak 3", "Ada", "Luffy", "Anime")    #5210411203_Febriyan
...
while True :
    ...
    if menu == '1' :
        print("\nMENU BUKU\n===============\n1. Tampil Buku")
        print("2. Cari Buku")   #5210411203_Febriyan
        ...
        if pilihan == '1' :
            print("\n==============================================")
            for buku in buku :
                buku.Tampil()#5210411203_Febriyan
            ...
            for x in buku :
                if kode == x.kode :
                    ...
                    print(f"Letak : {x.lokasi}")    #5210411203_Febriyan
                    print(f"Status : {x.info}\n")
                    print("==============================================")

    elif menu == '2' :
        print("\nMENU MAJALAH\n===============\n1. Tampil Data Majalah")
        print("2. Cari Majalah")        #5210411203_Febriyan
        pilihan = input("Pilihan : ") 
        ...
        if pilihan == '1' :
            ...
            for majalah in majalah :
                majalah.Tampil()#5210411203_Febriyan

        elif pilihan == '2' :
            kode = input("Masukan Kode Majalah\t: ")
            for x in majalah :#5210411203_Febriyan
                if kode == x.kode :
                    print("\n==============================================")
                    print(f"Judul : {x.judul}")
        ...
        print("2. Cari DVD")
        pilihan = input("Pilihan : ")  
        dvd = [dvd1, dvd2, dvd3, dvd4]  #5210411203_Febriyan

        if pilihan == '1' :
            print("\n==============================================")
            for dvd in dvd :
                dvd.Tampil()#5210411203_Febriyan
